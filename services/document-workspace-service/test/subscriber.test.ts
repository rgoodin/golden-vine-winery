 ...
 * external system, no reason to fake this. Same source event, same
 * checks as integration-service's own test/subscriber.test.ts - this is
 * this service's own independent copy of the mapping, not a shared one.
 */
